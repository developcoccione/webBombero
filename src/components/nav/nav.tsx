...
export default function Nav() {
  ...
  return (
    <>
      ...
      <header class="page-footer" style={{ background: "#ffff", "font-size": "0%", "padding-top": "1%", "padding-bottom": "0.1%", "font-family": "Franklin Gothic Medium', 'Arial Narrow", "margin": "0%", "justify-content": "space-evenly", "align-items": "center" }}>
        <div class="row">
          <ul class="center">
